...
with DAG(
    ...
    with TaskGroup("ingestion_group") as ingestion_group:
        load_csv = PythonOperator(
            ...
            op_kwargs={
                "url": os.getenv(
                    "DATA_SOURCE_URL",
                    "https://raw.githubusercontent.com/batchayw/tech-data-analysis/main/broadband_data_zipcode.csv",
                ),
        ...
        validate_data = PythonOperator(
            ...
            op_kwargs={"file_path": "/tmp/remote_data.csv", "min_rows": 1},
            dag=dag,
        )
    ...
    with TaskGroup("streaming_prep_group") as streaming_prep_group:
        stream_prep = PythonOperator(
            ...
            op_kwargs={"input_path": "/tmp/spark_processed.csv", "processing_time": 30},
            dag=dag,
        )
    ...
    # Pipeline End
    # ============================================
    pipeline_end = EmptyOperator(task_id="pipeline_end", dag=dag)
