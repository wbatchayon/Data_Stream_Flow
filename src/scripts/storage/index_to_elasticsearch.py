...
from elasticsearch.exceptions import ElasticsearchException, ConnectionError, NotFoundError
...
def index_to_elasticsearch(
    ...
    try:
        ...
        logger.info(f"Elasticsearch indexing completed: {indexed_count} documents indexed, {total_docs} total in index")
