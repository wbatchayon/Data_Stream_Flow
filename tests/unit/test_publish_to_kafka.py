...
from scripts.stream.publish_to_kafka import KafkaPublishError, publish_to_kafka
...
class TestPublishToKafka(unittest.TestCase):
    ...
    def test_publish_to_kafka_success(self, mock_producer_class):
        ...
        result = publish_to_kafka(
            input_path=self.input_path, bootstrap_servers="kafka:9092", topic="data_topic"
        )
